...
class ProbingClassifier(models.Model):
    def __init__(self,
        ...
        self.logit_layer = layers.Dense(classes_num)
        # TODO(students): end
    ...
    def call(self, inputs: tf.Tensor, training: bool =False) -> tf.Tensor:
        ...
        # TODO(students): start
        # ...
        layer_rep = self._pretrained_model(inputs)['layer_representations'][:, self._layer_num - 1, :]
        logits = self.logit_layer(layer_rep)
